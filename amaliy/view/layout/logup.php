...
if(isset($_POST['btn'])){
    ...
    echo $alfa=$db->query("INSERT INTO `users`(`name`, `login`, `parol`, `img`, `tel`) VALUES ('{$ism}' ,'{$login}','{$parol}','{$img}','{$tel}')");
    if($alfa){
        $_SESSION['ism']=$ism;
        ...
        <div class="row">
            <div class="col-6 offset-3">
                <form action="#" enctype="multipart/form-data" method="post" class=" my-4 border border-info p-3">
                    ...
                    <input type="password" name="parol" id="parol" class="form-control" required>
